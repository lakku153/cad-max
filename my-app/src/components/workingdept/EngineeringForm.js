...
const EngineeringForm = () => {
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            ...
            if (response.ok) {
                console.log('Engg form submitted:', data);
                setShowPopup(false); // Hide popup after successful submission
                alert('Engg form submitted successfully!');
            } else {
                console.error('Submission failed:', data);
                alert('Error submitting Engg form. Please try again.');
            }
        } catch (error) {
                ...
                <div className="engineering-form">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-input" name="Area"
                            value={formData.Area} onChange={handleChange} placeholder="Enter Area" />
                    </div>
                    <div className="form-group">
